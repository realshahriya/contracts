...
async function main() {
  console.log("🚀 Deploying HYPEY contracts directly (non-proxy) with correct ownership...");
  ...
  try {
    ...
    const filename = `direct-base-sepolia-${Date.now()}.json`;
    fs.writeFileSync(
    ...
    console.log("\n✅ All contracts are now owned by:", multisigAddress);
